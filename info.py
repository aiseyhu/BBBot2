...
# Bot information
SESSION = environ.get('SESSION', 'filmybabubhaiya_bot')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Ye Le {mention}👋\n\n{file_name}\n\n🔘 size - {file_size}\n\n╭─── • ❰ @crazyflashdeals ❱ • ────➤\n┣ ▫️ @shoppingoffersdeals_in\n┣ ▫️ @filmybabubhaiya_bot\n╰─────── • ◆ • ───────➤")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @filmybabubhaiya_bot \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','ninja495') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','shoppingoffersdeals_in') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+V_qtw2-eE3wwMDZl") #[ without @ ]
